...
data class KidsFoodDetailsUiState(
    val food:  KidsFoodItemDetailsUIState =  KidsFoodItemDetailsUIState(),
    val isLoading: Boolean = true,
    val error: BaseErrorUiState? = null
):BaseUiState

data class KidsFoodItemDetailsUIState(
    val id:Int? =0,
...
fun KidsFoodEntity.toUiDetailsState() = KidsFoodItemDetailsUIState(
    id = id,
    nameFood = nameFood,
    imgFood = imgFood,
