...
import com.aa.viewmodels.infants_food.InfantsFoodItemUIState
import com.aa.viewmodels.infants_food.InfantsFoodUIState
import com.aa.viewmodels.infants_food.InfantsFoodViewModel


@RequiresApi(Build.VERSION_CODES.Q)
@Composable
fun InfantsFoodScreen(
    navController: NavController,
    viewModel:InfantsFoodViewModel=hiltViewModel()
){
    ...
    InfantsFoodContent(
        ...
        viewModel = viewModel,
        navController = navController,
        onClickCard = navController::navigateToInfantFoodDetails
    )
}
...
@RequiresApi(Build.VERSION_CODES.Q)
@Composable
private fun InfantsFoodContent(
    state: InfantsFoodUIState,
    viewModel: InfantsFoodViewModel,
...
@Composable
private fun itemMatchesQuery(item: InfantsFoodItemUIState, query: String): Boolean {
