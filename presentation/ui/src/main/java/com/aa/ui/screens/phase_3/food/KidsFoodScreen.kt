...
import com.aa.viewmodels.phase_3.kids_food.KidsFoodItemUIState
import com.aa.viewmodels.phase_3.kids_food.KidsFoodUIState
import com.aa.viewmodels.phase_3.kids_food.KidsFoodViewModel
...
fun KidsFoodScreen(
    ...
    viewModel:KidsFoodViewModel=hiltViewModel()
){
    ...
    KidsFoodContent(
        ...
        viewModel = viewModel,
        navController = navController,
        onClickCard = navController::navigateToKidsFoodDetails
    )
}
...
@RequiresApi(Build.VERSION_CODES.Q)
@Composable
private fun KidsFoodContent(
    state: KidsFoodUIState,
    viewModel: KidsFoodViewModel,
...
@Composable
private fun itemMatchesQuery(item: KidsFoodItemUIState, query: String): Boolean {
