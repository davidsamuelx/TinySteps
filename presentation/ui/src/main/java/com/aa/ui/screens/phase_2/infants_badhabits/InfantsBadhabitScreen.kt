...
import com.aa.viewmodels.infants_badhabits.InfantsBadHabitItemUIState
import com.aa.viewmodels.infants_badhabits.InfantsBadHabitUIState
import com.aa.viewmodels.infants_badhabits.InfantsBadhabitViewModel


@RequiresApi(Build.VERSION_CODES.Q)
@Composable
fun InfantsBadHabitScreen(
    navController: NavController,
    viewModel: InfantsBadhabitViewModel = hiltViewModel(),
){
   ...
   BadHabitContent(
        ...
        viewModel = viewModel,
        navController = navController,
        onClickCard = navController::navigateToInfantsBadHabitDetailRoute
    )
...
private fun BadHabitContent(
    state: InfantsBadHabitUIState,
    viewModel: InfantsBadhabitViewModel,
...
@Composable
private fun itemMatchesQuery(item: InfantsBadHabitItemUIState, query: String): Boolean {
